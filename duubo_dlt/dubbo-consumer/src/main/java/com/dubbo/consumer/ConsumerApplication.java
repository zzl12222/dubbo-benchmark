...
public class ConsumerApplication {
    ...
    public static void main(String[] args) {
        ...
        BeanDefinitionBuilder beanDefinitionBuilder = BeanDefinitionBuilder.genericBeanDefinition(NettyConsumer.class);
        beanFactory.registerBeanDefinition("nettyConsumer", beanDefinitionBuilder.getBeanDefinition());
