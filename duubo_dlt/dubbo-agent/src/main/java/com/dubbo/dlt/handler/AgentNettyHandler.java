...
import com.dubbo.dlt.trendGenerator.ConsumerGenerator;
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Message msg) throws Exception {
        ...
        if (type == MessageType.HEARTBEAT) {
            ...
            if (msg.getClientType() == ClientType.CONSUMER) {
                ...
                ConsumerGenerator.writeConsumerHtml(msg.getData(), testConfig.getTestMode().toString().toLowerCase()+ "-"+msg.getClientType().toString().toLowerCase()+'-' + msg.getClientId() + ".html");
                if (msg.getClientType() == ClientType.CONSUMER) {
                ...
                String file_html_path = "provide_ressult" + msg.getClientId() + ".html";
